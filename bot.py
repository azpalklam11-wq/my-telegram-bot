...
# قراءة التوكن ومشرف البوت من متغيرات البيئة بأمان تام
...
def start(message):
    bot.send_message(message.chat.id, "أهلاً بك! تم استعادة نسختك كاملة وجاهزة للعمل.", reply_markup=get_main_markup(message.chat.id))
