...
def handle_message(message):
    ...
    if message.text in ['إشارات التداول', 'Classic mode']:
        ...
        bot.reply_to(message, "📂 سجل التداولات النشطة حالياً فارغ.", reply_markup=markup)
        
    elif message.text == 'التداول الاجتماعي':
        bot.reply_to(message, "👥 ميزة التداول الاجتماعي تتيح لك متابعة المتصدرين قريباً.", reply_markup=markup)
        
    elif message.text == 'المزيد':
        bot.reply_to(message, "⚙️ الإعدادات والمزيد من الخيارات متاحة قريباً.", reply_markup=markup)
