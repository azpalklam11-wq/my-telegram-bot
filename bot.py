rm -f otc_bot.py && cat << 'EOF' > otc_bot.py
import telebot
...
TOKEN = '8540596750:AAEI0Cko_9BcGINjKZBN_u-xkDKR20OiyCw'
ADMIN_ID = 6513565024
...
def start(message):
    bot.send_message(message.chat.id, "أهلاً بك! تم ضبط الأزرار والقوائم الرئيسية بنجاح.", reply_markup=get_main_markup(message.chat.id))
